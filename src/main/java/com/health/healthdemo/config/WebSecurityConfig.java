        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        , "/application/applications/{id}/status","/courses","/application/applications/course-stats","/application/preview/{id}","/application-details","/application//applications/{id}/documents/{documentType}",
                                "/application/application-details","/myapplications","/application/applications/{id}/download","/application/applications/{id}/full","/application/admin/applications/{id}/full","/application/application-stats")
